...
|--------------------------------------------------------------------------
|
| El proyecto corre con APP_LOCALE=es pero no tenía carpeta `lang/`, así que
| todos los mensajes de validación por defecto salían como claves crudas
| ("validation.required"). Este archivo es la traducción estándar de la
| comunidad Laravel-Lang para español, adaptada a las reglas que usa el
| sistema. Los FormRequest pueden seguir sobreescribiendo mensajes puntuales
| en su método `messages()`.
|
*/
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute proporcionado se ha filtrado en una brecha de datos. Elige otro.',
    ],
